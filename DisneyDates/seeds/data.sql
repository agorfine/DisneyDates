...
INSERT INTO users VALUES (DEFAULT, 1, 'Amanda', 'Gorfine', 'agorfine93@gmail.com', 25, 'princess', 'prince', 'Student', 'University of Delaware', 'Photographing couples get engaged in front of Cinderella Castle!', 'Meg from Hercules', 'Frozen', 'Epcot', 'Big Thunder Mountain');
INSERT INTO users VALUES (DEFAULT, 2, 'Emily', 'Nebrasky', 'emily@gmail.com', 25, 'princess', 'prince', 'Purchasing', 'University of Delaware', 'Watching the fireworks in MK as my last night in the Disney College Program', 'Yzma', 'Aladdin', 'Magic Kingdom', 'Splash Mountain');
INSERT INTO users VALUES (DEFAULT, 3, 'Aaron', 'Talan', 'aaron@gmail.com', 25, 'prince', 'princess', 'Accountant', 'University of Delaware', 'Drinking around the world at Epcot', 'Jafar', 'Frozen', 'Epcot', 'Its a small world');
INSERT INTO users VALUES (DEFAULT, 4, 'Fred', 'Mack', 'fred@gmail.com', 28, 'prince', 'princess', 'Account Manager', 'University of Pennsylvania', 'Conquring my fear of rollercoasters on Expedition Everest', 'Joy', 'Wreck it Ralph', 'Animal Kingdom', 'People Mover');
INSERT INTO users VALUES (DEFAULT, 5, 'Joe', 'Cilente', 'joe@gmail.com', 39, 'prince', 'princess', 'Chef', 'George Washington University', 'Walking down Main St and seeing Cinderella Castle for the first time', 'Sully', 'Sword and the Stone', 'Hollywood Studios', 'Space Mountain');
INSERT INTO users VALUES (DEFAULT, 6, 'Nina', 'Dreyfus', 'nina@gmail.com', 25, 'princess', 'prince', 'Teacher', 'The New School', 'Eating my first Mickey bar', 'Simba', 'Mulan', 'Magic Kingdom', 'Rock n Rollercoaster');
INSERT INTO users VALUES (DEFAULT, 7, 'Bradley', 'Peck', 'bradley@gmail.com', 27, 'prince', 'princess', 'Consultant', 'Cornell University', 'Watching the joy on my moms face as we rode the Peter Pan ride', 'Grumpy', 'Lion King', 'Hollywood Studios', 'Tower of Terror');
INSERT INTO users VALUES (DEFAULT, 8,'Colby', 'Girodano', 'colby@gmail.com', 25, 'princess', 'prince', 'Development Coordinator', 'Fordham University', 'Watching wishes fireworks show', 'Elsa', 'Frozen', 'Magic Kingdom', 'Buzz Lightyear Space Ranger Spin');

INSERT INTO userID VALUES (DEFAULT, 1, 'JDOCnQuXz7aKjwbAe2fryF6Ip2g1');
